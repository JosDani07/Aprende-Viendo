...
function imagenes() {
    ...
    var direccion = 'https://serviciovisionnorte.cognitiveservices.azure.com/vision/v3.0/analyze?visualFeatures=Categories,Description,Tags&details=Landmarks&language=zh'
...
function transliterar() {
    var datos = [{ "Text": info }]
    var direccion = 'https://api.cognitive.microsofttranslator.com/transliterate?api-version=3.0&language=zh-Hans&fromScript=Hans&toScript=Latn';
